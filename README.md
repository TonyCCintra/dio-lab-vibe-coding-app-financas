...
Projeto desenvolvido como parte do desafio **Criando um App de Organização de Finanças Pessoais com Vibe Coding** da DIO.

## Sobre o projeto

O **Grana em Dia AI** é um conceito de aplicativo de finanças pessoais com inteligência artificial, criado para ajudar usuários iniciantes a organizar receitas, despesas e metas financeiras usando linguagem natural.
...
### Telas sugeridas
- Tela inicial com visão geral do saldo
- Tela de chat com assistente financeiro
- Tela de histórico
- Tela de metas
